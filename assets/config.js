...
window.TAJWEED_AYAHS = [
  { text: 'أَوۡ زِدۡ عَلَيۡهِ وَرَتِّلِ ٱلۡقُرۡءَانَ تَرۡتِيلًا', ref: 'Аль-Муззаммиль, 73:4' },
  { text: 'ٱقۡرَأۡ بِٱسۡمِ رَبِّكَ ٱلَّذِى خَلَقَ', ref: 'Аль-Аляк, 96:1' },
  { text: 'وَلَقَدۡ يَسَّرۡنَا ٱلۡقُرۡءَانَ لِلذِّكۡرِ فَهَلۡ مِن مُّدَّكِرٍ', ref: 'Аль-Камар, 54:17' },
  { text: 'إِنَّا نَحۡنُ نَزَّلۡنَا ٱلذِّكۡرَ وَإِنَّا لَهُۥ لَحَـٰفِظُونَ', ref: 'Аль-Хиджр, 15:9' }
];
